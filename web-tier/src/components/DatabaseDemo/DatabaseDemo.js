    ...
    class DatabaseDemo extends Component {
        ...
        return (
            <div>
            <h1 id='title' style={{paddingRight:"1em"}}>Aurora Database</h1><input style={{float:"right", marginBottom:"1em"}} type = "button" value ="DEL" onClick={this.handleButtonClickDel} />
